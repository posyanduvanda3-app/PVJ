...
const icons = {
    ...
    heartPulse: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.5 12h3l1.5-3 3 6 1.5-3h3" /></svg>`,
    smile: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`,
...
// ==========================================
const API_URL = 'https://script.google.com/macros/s/AKfycbyddWu0Auqng1uyKvKEFtLG0WSPowt7JCncAPQDU5PzBteS5tsg1cYczn3SSi0KBYWS/exec';
    ...
    if (hasAccess('user')) {
        adminNav = `
            <div class="pt-4 border-t border-slate-800 mt-4 space-y-1">
                ...
                <button class="nav-btn ${state.currentMenu === 'user' ? 'active' : ''}" data-menu="user">${icons.userBadge} <span>Manajemen User</span></button>
    ...
    return `
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="card stat-card">
                ...
                <div class="stat-icon bg-rose-50 text-rose-600">${icons.smile}</div>
            </div>
            ...
            <div class="card stat-card">
                ...
                <div class="stat-icon bg-emerald-50 text-emerald-600">${icons.heartPulse}</div>
            </div>
        </div>
...
function renderRiwayat() {
    ...
    return `
        ...
        <div class="card p-0 overflow-hidden">
            ...
            <!-- ⚠️ PENTING: Class 'mobile-card-table' WAJIB ADA di sini agar CSS responsif bekerja -->
            <table class="data-table mobile-card-table">
                <thead>
                    <tr>
                        <th>Tanggal / ID</th>
                ...
                <tbody>
                    ${filtered.length ? filtered.map(p => `
                        <tr>
                            <!-- ⚠️ PENTING: Atribut 'data-label' WAJIB ADA di setiap <td> -->
                            ...
                            <!-- ⚠️ Class 'text-right' agar tombol aksi rapi di mobile -->
                            <td class="text-right" data-label="Aksi">
                                <div class="action-btns">
